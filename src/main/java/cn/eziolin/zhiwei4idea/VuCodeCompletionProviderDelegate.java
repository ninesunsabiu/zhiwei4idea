...
public class VuCodeCompletionProviderDelegate implements
        BiConsumer<CompletionParameters, CompletionResultSet> {
    ...
    private static Optional<HttpResponse<Supplier<BaseResponse<ViewMeta>>>> searchCards(String keyword) {
    ...
    public void accept(CompletionParameters parameters, CompletionResultSet resultSet) {
        getBeforeInputString(parameters).map(
